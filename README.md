...
Actions: how data is manipulated. 2 porperties, type, and payload.

Reducers: pure functions that take in current state & an action as arguments. use switch statements to check actions, reduces to single action and updates state.

Store: app state is stored in a single state object.

3. What does `redux-thunk` allow us to do? How does it change our `action-creators`?

Can use thunks in action creators to run async operations in redux, can have multiple calls to dispatch.

4. What is your favorite state management system you've learned and this sprint? Please explain why!

I see how redux is the standard. But I fund useReducer to be far more easy.
